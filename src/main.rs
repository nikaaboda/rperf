    ...
    let args = App::new("rperf")
        ...
        .arg(
            Arg::with_name("length")
                .help("length of the buffer to exchange; for TCP and TLS, this defaults to 32 kibibytes; for UDP, it's 1024 bytes")
                .takes_value(true)
                .long("length")
                .short("l")
                .required(false)
        ...
        .arg(
            ...
            Arg::with_name("tls_port_pool")
                .help("an optional pool of IPv4 TLS ports over which data will be accepted; if omitted, any OS-assignable port is used; format: 1-10,19,21")
                .takes_value(true)
                .long("tls-port-pool")
                .required(false)
                .default_value("")
